        ...
        if (Physics.Raycast(this.transform.position, this.transform.forward, out whatIHit, distanceToSee))
        {
            if (whatIHit.collider.tag == "Interact" && showUse == true)
            {
                ...
                if (Input.GetKeyDown(KeyCode.E))
                {
                    ...
                    {
                        showUse = false;
                        textMesh.text = "I'm so tired of the university...";
                        textMesh.enabled = true;
                    ...
                    {
                        showUse = false;
                        textMesh.text = "Social media is crazy talking about ROOM. A lot of strange things happen to the people who play it.";
                        textMesh.enabled = true;
